...
class StartScreen : AppCompatActivity() {
    ...
    private val mContext = this@StartScreen
        ...
        Handler().postDelayed({
            if (!backPressed) {
                if (sharedPreferences.getString("login", "") == "true") {
                    ...
                    startActivity(Intent(this@StartScreen, StudentLoginActivity::class.java))
                }
                finish()
            }
        }, 2000)
    ...
    fun getPostFromServer(postId: String){
        ...
        Handler().postDelayed({
            val intent = Intent(this,SinglePostsActivity::class.java)
