...
import com.tecent.student_assessment.ReplyObject
import com.tecent.student_assessment.adapters.MyRecyclerPostsCommentsRepliesAdapter.PostsCommentsRepliesHolder
...
class MyRecyclerPostsCommentsRepliesAdapter(requestQueue: RequestQueue, context: CommentsPostHome, postid:String,userid:String,replyObjectArrayList: ArrayList<ReplyObject>) : RecyclerView.Adapter<PostsCommentsRepliesHolder>() {
