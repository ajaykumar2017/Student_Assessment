...
class MyRecyclerHomePostsCommentsRepliesAdapter(
  requestQueue: RequestQueue,
  context: CommentsPostHomeActivity,
  postid: String,
  userid: String,
  replyObjectArrayList: ArrayList<ReplyObject>
) : RecyclerView.Adapter<PostsCommentsRepliesHolder>() {
  ...
  override fun onBindViewHolder(
    postsCommentsRepliesHolder: PostsCommentsRepliesHolder,
    position: Int
  ) {
