...
import kotlinx.android.synthetic.main.activity_search.tvEmpty
        ...
        try {
          ...
          if (result == "successful") {
            ...
            if (useridarray != null) {
              val len = useridarray.length()
              for (i in 0 until len) {
                useridpostdoubtslist.add(
                    useridarray.get(i)
                        .toString()
                )
                usernamepostdoubtslist.add(
                    usernamearray.get(i)
                        .toString()
                )
                userdppostdoubtslist.add(
                    userdparray.get(i)
                        .toString()
                )
                posttimepostdoubtslist.add(
                    posttimearray.get(i)
                        .toString()
                )
                userbranchpostdoubtslist.add(
                    userbrancharray.get(i)
                        .toString()
                )
                postdoubtidpostdoubtslist.add(
                    postdoubtidarray.get(i)
                        .toString()
                )
                posttextpostdoubtslist.add(
                    posttextarray.get(i)
                        .toString()
                )
                postimagepostdoubtslist.add(
                    postimagearray.get(i)
                        .toString()
                )
                noofanswerspostdoubtslist.add(
