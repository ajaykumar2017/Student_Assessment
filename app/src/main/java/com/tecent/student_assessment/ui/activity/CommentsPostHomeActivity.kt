...
class CommentsPostHomeActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    setContentView(
        layout.activity_comments_post_home
    )
    setSupportActionBar(
        findViewById(
            id.toolbar_main
    ...
    tv_btn_post_comment = findViewById<TextView>(
    ...
    editText.addTextChangedListener(object : TextWatcher {
      ...
      override fun onTextChanged(
        ...
        if (editText.text.toString()
          ...
          tv_btn_post_comment.setTextColor(
              ContextCompat.getColor(
                  this@CommentsPostHomeActivity,
                  color.colorPrimary
              )
          )
      ...
      object : VolleyMultipartRequest(Request.Method.POST, url, Response.Listener { response ->
        ...
        try {
          ...
          if (status == "successful") {
            ...
            editText.setText("")
            Toast.makeText(
                this@CommentsPostHomeActivity, "Comment uploaded successfully", Toast.LENGTH_SHORT
            )
                .show()
            volleyCommentDataRequest(postid)
          }
          if (status == "error") {
            dialog.dismiss()
            Toast.makeText(
                this@CommentsPostHomeActivity, "Error! Please try again later...",
                Toast.LENGTH_SHORT
            )
                .show()
          }
        ...
        dialog.dismiss()
        Toast.makeText(this@CommentsPostHomeActivity, "Volley Error", Toast.LENGTH_SHORT)
            .show()
      }) {
        override fun getParams(): Map<String, String> {
          ...
          params["commenttext"] = editText.text.toString()
              .replace("'", "\\'")
          return params
        }
        ...
        override fun getByteData(): Map<String, DataPart>? {
          ...
          params["commentimage"] = DataPart(
              "comment_image.jpg",
              AppHelper.getFileDataFromDrawable(
                  baseContext, ivAddAttachment.getDrawable()
              ), "image/jpeg"
          )
  ...
  fun volleyTestWithoutImage() {
    ...
    val stringRequest = object : StringRequest(
        ...
        Response.ErrorListener { error ->
          dialog.dismiss()
          Toast.makeText(this@CommentsPostHomeActivity, error.toString(), Toast.LENGTH_SHORT)
              .show()
      ...
      override fun getParams(): Map<String, String> {
        ...
        MyData["withimage"] = "no"
        MyData["commenttext"] = editText.text.toString()
            .replace("'", "\\'")
        return MyData
      }
    }
  ...
  fun jsonParser(jsontext: String) {
    try {
      ...
      if (result == "error") {
        dialog.dismiss()
        Toast.makeText(
            this@CommentsPostHomeActivity, "Error! Please try again later...", Toast.LENGTH_SHORT
        )
            .show()
      }
