...
import com.tecent.student_assessment.ui.activity.TestSeriesSubjectActivity
...
class TestSeriesFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(
            layout.test_series_fragment, container, false)
        algorithm = view.findViewById(R.id.algo)
        data_structure = view.findViewById(
            R.id.datastr
        )
        data_structure = view.findViewById(
            R.id.datastr
        )
        compiler_design = view.findViewById(
            R.id.compiler
        )
        theory_of_computation = view.findViewById(
            R.id.toc
        )
        database = view.findViewById(R.id.dbms)
        operating_system = view.findViewById(
            R.id.operating
        )
        digital_logic = view.findViewById(
            R.id.digital
        )
        computer_organization = view.findViewById(
            R.id.coa
        )
        computer_network = view.findViewById(
            R.id.cn
        )
        discrete_math = view.findViewById(R.id.dm)
        c_Lang = view.findViewById(R.id.clang)
        cpp_Lang = view.findViewById(R.id.cpplang)
        java_lang = view.findViewById(
            R.id.javalang
        )
        ...
        val intent = Intent(activity, TestSeriesSubjectActivity::class.java)
